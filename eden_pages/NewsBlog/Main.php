                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="single-blog style_two">
                        ...
                        <div class="short_details text-center ">
                            ...
                            <a class="d-block" href="eden_pages/single_blog.php?id=<?=$news_second['id']?>">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 col-xl-12">
                            <div class="single-blog style-three m_b_30">
                                ...
                                <div class="short_details">
                                    ...
                                    <a class="d-block" href="eden_pages/single_blog.php?id=<?=$news_sport_2['id']?>">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 col-xl-12">
                            <div class="single-blog style-three m_b_30">
                                ...
                                <div class="short_details">
                                    ...
                                    <a class="d-block" href="eden_pages/single_blog.php?id=<?=$fetch['id']?>">
